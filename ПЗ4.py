...
#     print(file.read())
Задание 1: Функция print_file_content читает и выводит первую строку файла.

Задание 2: Функция non_closed_files возвращает список открытых файлов.

Задание 3: Функция log_for фильтрует логи по дате и сохраняет в отдельный файл.
