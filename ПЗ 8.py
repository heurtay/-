...
ПЗ8.py
Задание 1: Класс UpperPrintString выводит строку в верхнем регистре.

Задание 2: Класс LowerString преобразует строку/список/словарь к нижнему регистру.

Задание 3: Класс FuzzyString сравнивает строки без учёта регистра.

Задание 4: Класс TitledText добавляет заголовок к строке.

Задание 5: Класс SuperInt расширяет функциональность целых чисел (итерация, повторение, бинарное представление).

Задание 6: Класс RoundedInt округляет число до ближайшего чётного или нечётного.
